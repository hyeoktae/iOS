...
class DetailViewUpperCell: UITableViewCell {
    ...
    private func makeConstraints() {
        [backgroundBlurView, backgroundLayerView, mainImageView, imageBelowStackView, playButton, movieTimeStackView, movieDescriptionStackView, myPokedStackView, evaluationStackView, shareStackView ].forEach { contentView.addSubview($0) }
